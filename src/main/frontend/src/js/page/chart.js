...
var BodyChart=React.createClass({
	render(){
		return(
			<div className='container'>
				...
				<div className="row">
	                  ...
	                  <form>
	                      <div style={{marginBottom:'0'}} className="form-group">
	                      	  <label className='padl pull-left'>填写字段</label>
	                          <input type="text" className="form-control search_ip" placeholder="请输入分析内容..."/>
	                          <Button href='' className='search_btns'>生成</Button>
	                      </div>
	                  </form>
            	...
            	<div className='row'>
            		<div className='col-lg-9'>
            			<h4 className='padding'>2016年政策数据公开莫及趋势</h4>
            			<Echart1/>
            		</div>
            		<div className='col-lg-3'>
            			<h4 className='padding'>热门分享</h4>
            			<div className='wh'>
            			<Echart2/>
            			<p>[树懒政策]2016年我打算啥也不干哈哈</p>
            			</div>
            		</div>
            	</div>
            	<div className='row'>
            		<div className='col-lg-9'>
            			<h5 className=''>数据信息</h5>
...
ReactDOM.render(
	<BodyChart/>,document.getElementsByClassName('g-bd')[0])