 ...
 */
@Service
public class TaskTemplateServiceImpl extends BaseService implements TaskTemplateService {
    @Autowired
    ...
    public TaskTemplate getTaskTemplateById(int tempId) {
        return taskTemplateDao.getTaskTemplateById(tempId);
    }
    ...
    public int addTaskTemplate(TaskTemplate taskTemplate) {
        return taskTemplateDao.addTaskTemplate(taskTemplate);
    }
    ...
    public void deleteTaskTemplate(TaskTemplate taskTemplate) {
        taskTemplateDao.deleteTaskTemplate(taskTemplate);
    }
    ...
    public List<TaskTemplate> searchTaskTemplate(Map<String, String> maps) {
        return taskTemplateDao.searchTaskTemplate(maps);
    }

    @Override
    public Integer searchTaskTemplateTotal(Map<String, String> maps) {
        return taskTemplateDao.searchTaskTemplateTotal(maps);
    }
}
