...
public class AdminResource implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        AdminResource adminResource = (AdminResource) o;

        if (id != null ? !id.equals(adminResource.id) : adminResource.id != null)
            return false;
    ...
    public String toString() {
        return "Resource{" + "id=" + id + ", name='" + name + '\'' + ", type=" + type
                + ", permission='" + permission + '\'' + ", parentId=" + parentId + ", parentIds='"
